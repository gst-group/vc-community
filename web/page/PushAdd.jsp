                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li><a href="">
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li><a href="${basePath}/lk-vc/admin/sendPushView.do" class="active"
                                   style="color:white;background-color:#DEDEDE">新建推送</a></li>
                        </ul>
                    </li>
        ...
        <div class="container-fluid">
           ...
           <div style="border:1px #CDCDC1 solid;width:185px;height:193px;padding-left:0px">
            ...
            <ul id="list2">
                    ...
                    <center>
                        <button type="submit"
                                style="background:#ed5f00;color:white;border:0px;width:100px;height:40px;width:100px;margin-top:80px;"
                                onclick="save()">确定
                        </button>
                    </center>
                </div>
                ...
                <h4 class="page-header">发送推送消息</h4>
                <form action="${basePath}/lk-vc/admin/sendPush.do" id="form1" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <div style="padding-left:120px" class="control-group">
                            <label class="control-label">邀请话题</label>
                            <div class="column">

                                <input id="search-highlight" class="form-control" style="width:815px"
                                       name="search-highlight" placeholder="Start typing here" type="text"
                                       data-list=".highlight_list" autocomplete="off">
                                <ul class="vertical highlight_list" id="uls" style='border:1px #DBDBDB solid'>
                                </ul>
                            </div>


                            <input type="hidden" id="hi" name="a">


                            <div style="padding-left:0px" class="control-group">
                                <label class="control-label">内容</label>
                                <textarea rows="5" class="form-control" name="content" value="" id="content"></textarea>
                            </div>
                        </div>
                        ...
                        <div style="padding-left:13%">
                            ...
                            <a href="javascript:;" class="file">
                                <img src="${basePath}/lk-vc/img/Button.png">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <input class="btn" type="button"
                                       ...
                                       class="btn btn-default" id="save_jobs" value="提交内容"/></div>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    $('#search-highlight').bind('input propertychange', function () {
        ...
        $
                .ajax({
                    url: "${basePath}/lk-vc/admin/getArticleTitle.do?content=" + content,
                    type: 'post',
                    dataType: "json",
