                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li><a href=""><i class="fa fa-drupal fa-fw"></i>
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li><a href="${basePath}/lk-vc/admin/Sensitive.do" class="active"
                                   style="color:white;background-color:#DEDEDE">敏感词检测</a></li>
    ...
    <div id="page-wrapper" style="min-height: 685px;">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <h4 class="page-header">敏感词</h4>
                <div>
                    <textarea id="SensitiveContent" rows="15" cols="100"></textarea><br>
                  <input class="but" type="button"
                                   style="background:#ed5f00;color:white;border:0px;width:100px;height:40px;margin-left:30%"
                                   class="btn btn-default" onclick="save()" value="提交"/>
                </div>
...
<script>
    $(function () {
        ...
        var urls="${basePath}/lk-vc/user/selectSensitive.do";
        console.log(urls);
        $.ajax({
            url:urls,
            data:sendConte,
            ...
            success:function (data) {
                document.getElementById("SensitiveContent").innerHTML=data.extra;
            },error:function (data) {
                alert(data.message);
            }
        });
    ...
    function  save() {
        ...
        $.ajax({
            url:"${basePath}/lk-vc/user/updateSensitive.do",
            data:sendConte,
            type:"post",
            dataType:"json",
            success:function (data) {
