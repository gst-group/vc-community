...
<li><a href="${basePath}/admin/messageHistory.do">聊天数据</a></li>
    ...
    <script type="text/javascript">
        $(".tcdPageCode").createPage({
            ...
            backFn: function (p) {
                location.href = "${basePath}/admin/diaryPraise.do?id=${id}&wantpage=" + p;
            }
        });
        ...
        function toPage() {
            ...
            if (isNaN(topage)) {
                ...
                location.href = "${basePath}/admin/diaryPraise.do?id=${id}&wantpage=" + topage;
            }
