...
<!DOCTYPE html>
<!-- saved from url=(0072)http://121.40.137.214:80/1/json.php?mod=admin&act=modifyPwdPage&1465824911 -->
<html lang="en">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li><a href=""><i class="fa fa-empire fa-fw"></i> 帐号管理<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li><a href="${basePath}/page/adminPass.jsp" class="active"
                                   style="color:white;background-color:#DEDEDE">修改密码</a></li>
                        </ul>
                    </li>
</c:if>
                            ...
                            <form role="form">
                                <fieldset>
                                    <div class="form-group">
                                        <input id="password" class="form-control" placeholder="原密码" name="password"
                                               type="password" value="">
                                    </div>
                                    <div class="form-group">
                                        <input id="repassword" class="form-control" placeholder="重置密码" name="repassword"
                                               type="password" value="">
                                    </div>
                                    <!-- Change this to a button or input when using this as a form -->
                                    <a onclick="modifyPwd();" class="btn btn-lg btn-success btn-block">提交</a>
                                </fieldset>
                                <div style="margin-top:10px"><input type="button"
                                                                    class="btn btn-lg btn-success btn-block"
                                                                    onclick="loginOut()" value="切换用户"></div>
...
<script type="text/javascript">
    ...
    function modifyPwd() {
        ...
        $.ajax({
            type: 'POST',
            url: '${basePath}/admin/adminInfo.do',
            data: {pwd1: $("#password").val(), pwd2: $("#repassword").val()},
            dataType: 'json',
            timeout: 300,
            success: function (data) {
                if (data.message == "success") {
