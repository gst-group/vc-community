<!DOCTYPE html>
<!-- saved from url=(0068)http://121.40.137.214:80/1/json.php?mod=admin&act=groupList&1465824931 -->
<html lang="en">
...
<div id="wrapper">
    ...
    <div id="page-wrapper" style="min-height: 685px;">
        <div class="container-fluid">
            <div class="row">
                <h3 class="page-header">群组修改</h3>
                <div class="table-responsive" style="font-size:12px">
                    <table>
                        <tr style="height:50px">
                            <td>群名称:</td>
                            <td><input type="text" id="gname" value="${name}" style="width:155px"></td>
                        </tr>
                        <p>
                            <tr style="height:50px">
                                <td>群描述:</td>
                                <td>
                                    <textarea rows="5" cols="22" id="desc">${desc }</textarea>
                                </td>
                            </tr>
                            <tr style="height:50px">
                                <td>最大人数:</td>
                                <td><input type="text" id="max" value="${max }" style="width:155px"></td>
                            </tr>
                    </table>

                    <div style="padding-left:84px"><input type="button" onclick="save(/${id}/)"
                                                          style="background:#ed5f00;color:white;border:0px;width:100px;height:35px;"
                                                          value="保&nbsp;&nbsp;存"></div>
        ...
        <script type="text/javascript">
            function save(id) {
                ...
                var urls = "${basePath}/admin/groupChang.do?gid=" + id + "&gname=" + gname + "&desc=" + desc + "&max=" + max;
                $.ajax({
                    url: urls,
                    type: 'post',
                    dataType: "text",
