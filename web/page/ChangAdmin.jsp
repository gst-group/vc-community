<!DOCTYPE html>
<!-- saved from url=(0071)http://121.40.137.214:80/1/json.php?mod=admin&act=newAdminPage&1465824901 -->
<html lang="en">
...
<script>
    window.onload = function () {
        ...
        if (a[1] == undefined || a[1] == "" || a[1].length == 0) {
// 			var msg='${message}';
// 			if(msg!=null){
// 				alert(msg);
// 			}
            ...
            document.getElementById("id").value = a[2];
            document.getElementById("name").value = decodeURI(a[3]);
            document.getElementById("pwd").value = a[4];
            document.getElementById("nickname").value = decodeURI(a[5]);
        }
    }
</script>
<body>
...
--%>
    ...
    <div id="page-wrapper" style="min-height: 685px;">
        <div class="container-fluid">
            <div class="row">
                <h4 class="page-header">修改管理员</h4>
                <form action="" class="form-horizontal" enctype="multipart/from-data" method="post" style="width:90%"
                      role="form">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">账号：</label>
                        <div class="col-sm-5"><input type="text" class="form-control" name="name" id="name" value="">
                            <input type="hidden" class="form-control" name="id" id="id" value=""></div>

                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">昵称：</label>
                        <div class="col-sm-5"><input type="text" class="form-control" name="nickname" id="nickname" value="">
                        </div>

                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">初始密码：</label>
                        <div class="col-sm-5"><input type="text" class="form-control" name="password" id="pwd" value="">
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="button" onclick="sub()" class="btn btn-default" id="save_jobs">保存</button>
                        </div>
                    </div>
...
<script type="text/javascript">
    function sub() {
        ...
        var url = "${basePath}/admin/adminInfo.do?name=" + name + "&password=" + pwd + "&id=" + id+"&nickname="+nickname;
