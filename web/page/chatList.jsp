<!DOCTYPE html>
<!-- saved from url=(0067)http://121.40.137.214:80/1/json.php?mod=admin&act=dataList&1465824963 -->
<html lang="en">
<head>
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://121.40.137.214:80/1/index.html">Admin v2.0</a>
        </div>
        <!-- /.navbar-header -->
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li><a href="">
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li><a href="${basePath}/admin/userGroup.do">话题分组</a></li>
                    ...
                    <li><a href="">
                        <i class="fa fa-empire fa-fw"></i> 群组管理<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="${basePath}/admin/groupInfo.do">群组列表</a></li>
                            <li><a href="${basePath}/admin/allUser.do">添加群组</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a href=""><i class="fa fa-drupal fa-fw"></i>
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li><a href="${basePath}/admin/userList.do">用户管理</a></li>
                            <li><a href="${basePath}/page/UserAdd.jsp">新开用户</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a href="">
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li><a href="${basePath}/admin/messageList.do">通知列表</a></li>
                            <li><a href="${basePath}/page/PushAdd.jsp">新建通知</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a href="">
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li><a href="${basePath}/admin/ScoreList.do">积分规则修改</a></li>
                    ...
                    <li><a href="">
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li><a href="${basePath}/admin/userData.do.do">用户数据</a></li>
    ...
    <div id="page-wrapper" style="min-height: 685px;">
        <div class="container-fluid">
            <div class="row">
                <h4 class="page-header">èå¤©è®°å½</h4>
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            <td>5</td>
                            <td>ç¾¤è</td>
                            <td>2016-04-22 21:47:20</td>
                            <td>faucon</td>
                            <td>æµè¯</td>
                            <td><img width="150px" src="./chatList_files/bbcdd340-0890-11e6-869e-6b4b8935cc55"></td>
                        </tr>
                        <tr>
                            <td>6</td>
                            <td>ç¾¤è</td>
                            <td>2016-04-23 07:29:10</td>
                            <td>faucon</td>
                            <td>æµè¯</td>
                            <td>[):]</td>
                        </tr>
                    ...
                    <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
                        <ul class="pagination">
                            <li class="paginate_button disabled" tabindex="0"><a href="javascript:;">é¦é¡µ</a></li>
                            <li class="paginate_button previous disabled" tabindex="0"><a
                                    href="javascript:;">ä¸ä¸é¡µ</a></li>
                            <li class="paginate_button active" tabindex="0"><a
                                    href="http://121.40.137.214:80/1/json.php?mod=admin&act=dataList&page=1">1</a></li>
                            <li class="paginate_button next disabled" tabindex="0"><a href="javascript:;">ä¸ä¸é¡µ</a>
                            </li>
                            <li class="paginate_button disabled" tabindex="0"><a href="javascript:;">å°¾é¡µ</a></li>
                        </ul>
                        <div id="dataTables-example_filter" class="dataTables_filter">
                            æ»é¡µæ°:1,éæ©è·³è½¬é¡µ:<input size="8" type="text" value="1" id="to_page">
                            <button onclick="toPage();return false;" type="button" class="btn btn-default">ç¡®å®
                            </button>
                            &nbsp;<a href="http://121.40.137.214:80/1/json.php?mod=admin&act=export" target="_blank">å¯¼åºæ°æ®</a>
                        </div>
                        <br><br>
                        <!-- <ul class="pagination">
    ...
    <script>var isSuperAdmin = <c:out value="${userInfo.superAdmin?'true':'false'}"/></script>
    ...
    <script type="text/javascript">
        ...
        function toPage() {
            location.href = "/1/json.php?mod=admin&act=dataList&page=" + $('#to_page').val();
        }
        ;
    </script>
