<!DOCTYPE html>
<!-- saved from url=(0067)http://121.40.137.214:80/1/json.php?mod=admin&act=helpPage&1465824975 -->
<html lang="en">
...
<div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li><a href="">
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li><a href="${basePath}/page/Help.jsp" class="active"
                                   style="color:white;background-color:#DEDEDE">帮助</a></li>
                        </ul>
                    </li>
</c:if>
    ...
    <div id="page-wrapper" style="min-height: 685px;">
        <div class="container-fluid">
            <div class="row">
                <h4 class="page-header">添加帮助信息</h4>
                <form action="" class="form-horizontal" enctype="multipart/from-data" method="post" style="width:90%"
                      role="form">
                    <span style="padding-left:90px"><b>标题</b>：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
                            type="text" id="title"></span>
                    <p>
                    <div class="form-group">

                        <label class="col-sm-2 control-label">帮助信息：</label>
                        <div class="col-sm-8"><textarea rows="20" class="form-control" name="help"
                                                        id="content"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="button" onclick="save()"
                                    style="width:100px;background:#ed5f00;color:white;border:0px;font-size:15px;height:40px;"
...
<script type="text/javascript">
    function save() {
        ...
        if (title.length == 0 || content.length == 0) {
            ...
            $
                    .ajax({
                        url: "${basePath}/admin/help/add.do?title=" + title + "&content=" + content,
                        type: 'post',
                        dataType: "json",
                        success: function (data, textStatus) {
                            if (data.message == "success") {
                                alert("添加成功");
                                location = "${basePath}/admin/feedbackList.do";
                            } else {
                                alert("添加失败");
                            }
                        }
